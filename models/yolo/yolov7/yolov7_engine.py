...
if __name__ == '__main__':
    ...
    # Run yolo
    base_folder = './yolo/yolov7/yolov7'
    subprocess.call(
        ['python', f'{base_folder}/detect.py', '--weights', f'{base_folder}/yolov7-e6e.pt', '--source', opt.source,
                '--json_output_path', results_json, '--nosave', '--no-trace'])
